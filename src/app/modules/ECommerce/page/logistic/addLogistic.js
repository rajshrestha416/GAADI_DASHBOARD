...
function AddLogistic({ closeAddLogistic }) { 
  ...
  const addLogistic = () => {
    axios.post("http://localhost:3001/api/auth/register", logisticdata)
      .then(response => {
  ...
  const addSuccess = () => {
    toast.success("Logistic Added Successfully", {
      position: "top-center",
      autoClose: 5000,
  ...
  const addFailed = () => {
    toast.error("Failed to Add Logistic", {
      position: "top-center",
      autoClose: 5000,
      hideProgressBar: false,
      closeOnClick: true,
